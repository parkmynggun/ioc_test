...
module microblaze_riscv_0_local_memory_imp_OTQK70
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_btn_fnd microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_btn_fnd_dlmb_bram_if_cntlr_2 dlmb_bram_if_cntlr
  ...
  soc_btn_fnd_dlmb_v10_2 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_btn_fnd_ilmb_bram_if_cntlr_2 ilmb_bram_if_cntlr
  ...
  soc_btn_fnd_ilmb_v10_2 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  soc_btn_fnd_lmb_bram_2 lmb_bram
...
(* CORE_GENERATION_INFO = "soc_btn_fnd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_btn_fnd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=2,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=8,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=3,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "soc_btn_fnd.hwdef" *) 
module soc_btn_fnd
   (com_0,
    dht11_data_0,
  ...
  soc_btn_fnd_axi_gpio_1_0 axi_gpio_btn
  ...
  soc_btn_fnd_axi_uartlite_0_1 axi_uartlite_0
       (.rx(usb_uart_rxd),
        .s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .tx(usb_uart_txd));
  soc_btn_fnd_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_btn_fnd_mdm_1_2 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_btn_fnd microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_btn_fnd_microblaze_riscv_0_1 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_OTQK70 microblaze_riscv_0_local_memory
  ...
  soc_btn_fnd_myip_dht_0_1 myip_dht_0
  ...
  soc_btn_fnd_myip_fnd_0_1 myip_fnd_0
       (.com(com_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
