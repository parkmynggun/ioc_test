...
//Date        : Fri Sep  5 14:09:55 2025
//Host        : user11-B70TV-AN5TB8W running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target dht11.bd
//Design      : dht11
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "dht11,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dht11,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=13,numNonXlnxBlks=2,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "dht11.hwdef" *) 
module dht11
   (com_0,
    dht11_data_0,
    led_0,
  ...
  output [7:0]seg_7_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN dht11_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  dht11_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
  ...
  (* BMM_INFO_PROCESSOR = "riscv > dht11 microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  dht11_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_1M1D3K3 microblaze_riscv_0_local_memory
  ...
  dht11_myip_dht11_tap_tap11_0_0 myip_dht11_tap_tap11_0
  ...
  dht11_myip_fnd_0_0 myip_fnd_0
       (.com(com_0),
        ...
        .seg_7(seg_7_0));
  dht11_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
...
module microblaze_riscv_0_local_memory_imp_1M1D3K3
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > dht11 microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  dht11_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  dht11_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  dht11_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
