...
//Date        : Tue Sep 16 10:17:46 2025
//Host        : user11-B70TV-AN5TB8W running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target soc_pwm_led.bd
//Design      : soc_pwm_led
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module microblaze_riscv_0_local_memory_imp_11AU0JC
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_pwm_led microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_pwm_led_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  soc_pwm_led_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_pwm_led_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  soc_pwm_led_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  soc_pwm_led_lmb_bram_0 lmb_bram
...
(* CORE_GENERATION_INFO = "soc_pwm_led,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_pwm_led,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=20,numReposBlks=19,numNonXlnxBlks=6,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=12,da_board_cnt=13,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_pwm_led.hwdef" *) 
module soc_pwm_led
   (btn_0,
    btn_1,
    iic_rtl_scl_i,
  ...
  input rx_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN soc_pwm_led_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  output tx_0;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart_0 RxD" *) (* X_INTERFACE_MODE = "Master" *) input usb_uart_0_rxd;
  (* X_INTERFACE_INFO = "xilinx.com:interface:uart:1.0 usb_uart_0 TxD" *) output usb_uart_0_txd;
  input vauxn14_0;
  input vauxn15_0;
  input vauxn6_0;
  input vauxn7_0;
  ...
  wire [4:0]axi_smc_M07_AXI_ARADDR;
  wire [2:0]axi_smc_M07_AXI_ARPROT;
  wire axi_smc_M07_AXI_ARREADY;
  wire axi_smc_M07_AXI_ARVALID;
  wire [4:0]axi_smc_M07_AXI_AWADDR;
  wire [2:0]axi_smc_M07_AXI_AWPROT;
  ...
  soc_pwm_led_axi_iic_0_0 axi_iic_0
  ...
  soc_pwm_led_axi_uartlite_0_0 axi_uartlite_0
       (.rx(rx_0),
        .s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .tx(tx_0));
  soc_pwm_led_axi_uartlite_1_0 axi_uartlite_1
       (.rx(usb_uart_0_rxd),
        .s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .tx(usb_uart_0_txd));
  soc_pwm_led_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_pwm_led_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_pwm_led microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_pwm_led_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_11AU0JC microblaze_riscv_0_local_memory
  ...
  soc_pwm_led_myip_adc_new_0_0 myip_adc_new_0
       (.s00_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .vauxp6(vauxp6_0),
        .vauxp7(vauxp7_0));
  soc_pwm_led_myip_btn_0_0 myip_btn_0
       (.btn(btn_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_led_myip_btn_1_0 myip_btn_1
       (.btn(btn_1),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
        .s00_axi_araddr(axi_smc_M07_AXI_ARADDR),
        .s00_axi_aresetn(proc_sys_reset_0_peripheral_aresetn),
        .s00_axi_arprot(axi_smc_M07_AXI_ARPROT),
        .s00_axi_arready(axi_smc_M07_AXI_ARREADY),
        .s00_axi_arvalid(axi_smc_M07_AXI_ARVALID),
        .s00_axi_awaddr(axi_smc_M07_AXI_AWADDR),
        .s00_axi_awprot(axi_smc_M07_AXI_AWPROT),
        .s00_axi_awready(axi_smc_M07_AXI_AWREADY),
        .s00_axi_awvalid(axi_smc_M07_AXI_AWVALID),
        .s00_axi_bready(axi_smc_M07_AXI_BREADY),
        .s00_axi_bresp(axi_smc_M07_AXI_BRESP),
        .s00_axi_bvalid(axi_smc_M07_AXI_BVALID),
        .s00_axi_rdata(axi_smc_M07_AXI_RDATA),
        .s00_axi_rready(axi_smc_M07_AXI_RREADY),
        .s00_axi_rresp(axi_smc_M07_AXI_RRESP),
        .s00_axi_rvalid(axi_smc_M07_AXI_RVALID),
        .s00_axi_wdata(axi_smc_M07_AXI_WDATA),
        .s00_axi_wready(axi_smc_M07_AXI_WREADY),
        .s00_axi_wstrb(axi_smc_M07_AXI_WSTRB),
        .s00_axi_wvalid(axi_smc_M07_AXI_WVALID));
  soc_pwm_led_myip_pwm_0_0 myip_pwm_0
       (.pwm(pwm_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_led_myip_pwm_1_0_0 myip_pwm_1_0
       (.pwm_1(pwm_1_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_led_myip_pwm_2_0_0 myip_pwm_2_0
       (.pwm_2(pwm_2_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_pwm_led_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
