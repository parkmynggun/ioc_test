...
#ifndef _soc_intc_microblaze_riscv_0_xlconcat_0_core_h_
#define _soc_intc_microblaze_riscv_0_xlconcat_0_core_h_
...
class soc_intc_microblaze_riscv_0_xlconcat_0_core : public sc_module 
{
    public: 
       soc_intc_microblaze_riscv_0_xlconcat_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(soc_intc_microblaze_riscv_0_xlconcat_0_core);
    ...
    virtual ~soc_intc_microblaze_riscv_0_xlconcat_0_core() = default;
