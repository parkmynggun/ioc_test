...
//Date        : Fri Sep  5 10:33:29 2025
//Host        : user11-B70TV-AN5TB8W running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target dht_11.bd
//Design      : dht_11
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "dht_11,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=dht_11,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=12,numNonXlnxBlks=1,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "dht_11.hwdef" *) 
module dht_11
   (dht11_data_0,
    led_0,
    reset,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN dht_11_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  dht_11_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  dht_11_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  dht_11_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > dht_11 microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  dht_11_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_CX5AJV microblaze_riscv_0_local_memory
  ...
  dht_11_myip_dht11tap_0_0 myip_dht11tap_0
  ...
  dht_11_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
...
module microblaze_riscv_0_local_memory_imp_CX5AJV
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > dht_11 microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  dht_11_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  dht_11_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  dht_11_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
