...
//Date        : Thu Sep 11 08:25:30 2025
//Host        : user11-B70TV-AN5TB8W running 64-bit Ubuntu 24.04.3 LTS
//Command     : generate_target soc_adc_adc_new.bd
//Design      : soc_adc_adc_new
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module microblaze_riscv_0_local_memory_imp_1R4QC0V
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_adc_adc_new microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_adc_adc_new_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  soc_adc_adc_new_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_adc_adc_new_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  soc_adc_adc_new_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  soc_adc_adc_new_lmb_bram_0 lmb_bram
...
(* CORE_GENERATION_INFO = "soc_adc_adc_new,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=soc_adc_adc_new,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=14,numNonXlnxBlks=3,numHierBlks=1,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=2,da_clkrst_cnt=1,da_microblaze_riscv_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "soc_adc_adc_new.hwdef" *) 
module soc_adc_adc_new
   (btn_0,
    com_0,
    reset,
    seg_7_0,
  ...
  output [7:0]seg_7_0;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN soc_adc_adc_new_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  soc_adc_adc_new_axi_smc_0 axi_smc
  ...
  soc_adc_adc_new_axi_uartlite_0_1 axi_uartlite_0
       (.rx(usb_uart_rxd),
        ...
        .tx(usb_uart_txd));
  soc_adc_adc_new_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_adc_adc_new_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_adc_adc_new microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_adc_adc_new_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_1R4QC0V microblaze_riscv_0_local_memory
  ...
  soc_adc_adc_new_myip_adc_new_0_1 myip_adc_new_0
       (.s00_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .vauxp6(vauxp6_0),
        .vauxp7(vauxp7_0));
  soc_adc_adc_new_myip_btn_0_0 myip_btn_0
       (.btn(btn_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
  ...
  soc_adc_adc_new_myip_fnd_0_0 myip_fnd_0
       (.com(com_0),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .seg_7(seg_7_0));
  soc_adc_adc_new_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
