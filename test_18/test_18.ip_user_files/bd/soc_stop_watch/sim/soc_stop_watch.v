...
module microblaze_riscv_0_local_memory_imp_JF9TWY
   (DLMB_abus,
    DLMB_addrstrobe,
    DLMB_be,
    DLMB_ce,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x00000000 32 > soc_stop_watch microblaze_riscv_0_local_memory/lmb_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_stop_watch_dlmb_bram_if_cntlr_0 dlmb_bram_if_cntlr
  ...
  soc_stop_watch_dlmb_v10_0 dlmb_v10
       (.LMB_ABus(microblaze_riscv_0_dlmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_dlmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_dlmb_bus_BE),
        .LMB_CE(DLMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_dlmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_dlmb_bus_WAIT));
  soc_stop_watch_ilmb_bram_if_cntlr_0 ilmb_bram_if_cntlr
  ...
  soc_stop_watch_ilmb_v10_0 ilmb_v10
       (.LMB_ABus(microblaze_riscv_0_ilmb_bus_ABUS),
        .LMB_AddrStrobe(microblaze_riscv_0_ilmb_bus_ADDRSTROBE),
        .LMB_BE(microblaze_riscv_0_ilmb_bus_BE),
        .LMB_CE(ILMB_ce),
        ...
        .Sl_UE(microblaze_riscv_0_ilmb_bus_UE),
        .Sl_Wait(microblaze_riscv_0_ilmb_bus_WAIT));
  soc_stop_watch_lmb_bram_0 lmb_bram
...
module soc_stop_watch
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLOCK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLOCK, CLK_DOMAIN soc_stop_watch_sys_clock, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clock;
  ...
  soc_stop_watch_axi_gpio_0_0 axi_gpio_0
  ...
  soc_stop_watch_axi_iic_0_0 axi_iic_0
       (.s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .sda_o(iic_rtl_sda_o),
        .sda_t(iic_rtl_sda_t));
  soc_stop_watch_axi_smc_0 axi_smc
  ...
  soc_stop_watch_axi_uartlite_0_0 axi_uartlite_0
       (.rx(usb_uart_rxd),
        .s_axi_aclk(microblaze_riscv_0_Clk),
        ...
        .tx(usb_uart_txd));
  soc_stop_watch_clk_wiz_0 clk_wiz
       (.clk_in1(sys_clock),
        .clk_out1(microblaze_riscv_0_Clk),
        .reset(reset));
  soc_stop_watch_mdm_1_0 mdm_1
  ...
  (* BMM_INFO_PROCESSOR = "riscv > soc_stop_watch microblaze_riscv_0_local_memory/dlmb_bram_if_cntlr" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  soc_stop_watch_microblaze_riscv_0_0 microblaze_riscv_0
  ...
  microblaze_riscv_0_local_memory_imp_JF9TWY microblaze_riscv_0_local_memory
  ...
  soc_stop_watch_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
