...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_9 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work generic_baseblocks_v2_1_2 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_register_slice_v2_1_33 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_11 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work axi_data_fifo_v2_1_32 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_crossbar_v2_1_34 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xlconcat_v2_1_6 $vlogan_opts +v2k +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.stop_watch_intc xil_defaultlib.glbl -o stop_watch_intc_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./stop_watch_intc_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key stop_watch_intc_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc stop_watch_intc_simv.daidir vcs_lib c.obj)
