...
#
# Script generated by Vivado on Fri Sep 12 14:42:37 KST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : stop_watch_intc.sh
...
#
# Usage        : stop_watch_intc.sh
#                stop_watch_intc.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                stop_watch_intc.sh [-reset_run]
#                stop_watch_intc.sh [-reset_log]
#                stop_watch_intc.sh [-help]
#
...
#                script (type 'stop_watch_intc.sh -help' for more information).
#
...
# script info
echo -e "stop_watch_intc.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./stop_watch_intc.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_11 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_32 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/65ce/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_crossbar_v2_1_34 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconcat_v2_1_6 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/stop_watch_intc/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.stop_watch_intc xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.stop_watch_intc -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log stop_watch_intc_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./stop_watch_intc.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: stop_watch_intc.sh [-help]\n\
Usage: stop_watch_intc.sh [-step]\n\
Usage: stop_watch_intc.sh [-lib_map_path]\n\
Usage: stop_watch_intc.sh [-reset_run]\n\
Usage: stop_watch_intc.sh [-reset_log]\n\
Usage: stop_watch_intc.sh [-keep_index]\n\
Usage: stop_watch_intc.sh [-noclean_files]\n\n\
