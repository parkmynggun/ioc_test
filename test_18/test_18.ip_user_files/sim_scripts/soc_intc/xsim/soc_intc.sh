...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_16 -L microblaze_v11_0_14 -L microblaze_riscv_v1_0_3 -L lmb_v10_v3_0_14 -L lmb_bram_if_cntlr_v4_0_25 -L blk_mem_gen_v8_4_9 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L axi_lite_ipif_v3_0_4 -L axi_intc_v4_1_20 -L xlconcat_v2_1_6 -L mdm_riscv_v1_0_3 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot soc_intc xil_defaultlib.soc_intc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim soc_intc -key {Behavioral:sim_1:Functional:soc_intc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_e39f.protoinst" -protoinst "protoinst_files/soc_pwm_led.protoinst" -protoinst "protoinst_files/bd_b74d.protoinst" -protoinst "protoinst_files/soc_stop_watch.protoinst" -protoinst "protoinst_files/bd_9313.protoinst" -protoinst "protoinst_files/soc_lcd_dht11.protoinst" -protoinst "protoinst_files/bd_92f9.protoinst" -protoinst "protoinst_files/soc_hi.protoinst" -protoinst "protoinst_files/bd_495c.protoinst" -protoinst "protoinst_files/soc_adc_new.protoinst" -protoinst "protoinst_files/bd_5efd.protoinst" -protoinst "protoinst_files/soc_adc_fnd.protoinst" -protoinst "protoinst_files/bd_eb54.protoinst" -protoinst "protoinst_files/soc_adc_adc_new.protoinst" -protoinst "protoinst_files/bd_c826.protoinst" -protoinst "protoinst_files/iic_lcd.protoinst" -protoinst "protoinst_files/bd_1901.protoinst" -protoinst "protoinst_files/bd_1d4f.protoinst" -protoinst "protoinst_files/dht11.protoinst" -protoinst "protoinst_files/soc_intc.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_intc.wdb xsim.dir libdpi.so)
