...
#
# Script generated by Vivado on Tue Sep 09 17:19:55 KST 2025
...
#
# Usage        : xadc_wiz_2.sh
#                xadc_wiz_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xadc_wiz_2.sh [-reset_run]
#                xadc_wiz_2.sh [-reset_log]
#                xadc_wiz_2.sh [-help]
#
...
# script info
echo -e "xadc_wiz_2.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xadc_wiz_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xadc_wiz_2 xil_defaultlib.xadc_wiz_2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xadc_wiz_2 -key {Behavioral:sim_1:Functional:xadc_wiz_2} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_b74d.protoinst" -protoinst "protoinst_files/soc_stop_watch.protoinst" -protoinst "protoinst_files/bd_5efd.protoinst" -protoinst "protoinst_files/soc_adc_fnd.protoinst" -protoinst "protoinst_files/bd_c826.protoinst" -protoinst "protoinst_files/iic_lcd.protoinst" -protoinst "protoinst_files/bd_9313.protoinst" -protoinst "protoinst_files/soc_lcd_dht11.protoinst" -protoinst "protoinst_files/bd_1901.protoinst" -protoinst "protoinst_files/bd_1d4f.protoinst" -protoinst "protoinst_files/dht11.protoinst" -protoinst "protoinst_files/bd_92f9.protoinst" -protoinst "protoinst_files/soc_hi.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb xadc_wiz_2.wdb xsim.dir libdpi.so)
...
Usage: xadc_wiz_2.sh [-step]\n\
Usage: xadc_wiz_2.sh [-lib_map_path]\n\
Usage: xadc_wiz_2.sh [-reset_run]\n\
Usage: xadc_wiz_2.sh [-reset_log]\n\
Usage: xadc_wiz_2.sh [-keep_index]\n\
