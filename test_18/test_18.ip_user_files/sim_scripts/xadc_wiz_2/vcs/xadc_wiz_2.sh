...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key xadc_wiz_2_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xadc_wiz_2_simv.daidir vcs_lib c.obj)
