...
#                script (type 'xadc_wiz_2.sh -help' for more information).
#
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.xadc_wiz_2 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.xadc_wiz_2 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log xadc_wiz_2_sc.so .tmp_log xcelium_lib waves.shm c.obj)
