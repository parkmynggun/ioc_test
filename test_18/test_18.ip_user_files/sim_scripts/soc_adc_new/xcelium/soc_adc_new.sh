...
#
# Script generated by Vivado on Wed Sep 10 15:41:16 KST 2025
# SW Build 5239630 on Fri Nov 08 22:34:34 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : soc_adc_new.sh
...
#
# Usage        : soc_adc_new.sh
#                soc_adc_new.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                soc_adc_new.sh [-reset_run]
#                soc_adc_new.sh [-reset_log]
#                soc_adc_new.sh [-help]
#
...
#                script (type 'soc_adc_new.sh -help' for more information).
#
...
# script info
echo -e "soc_adc_new.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./soc_adc_new.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_9 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xlconstant_v1_1_9 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work smartconnect_v1_0 $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_33 $xmvlog_opts +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
  "../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3ee4/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_19 $xmvlog_opts -sv +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/3cbc" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/f0b6/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/0127/hdl/verilog" +incdir+"../../../../test_18.gen/sources_1/bd/soc_adc_new/ipshared/ec67/hdl" +incdir+"/home/user11/tools/Vivado/2024.2/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.soc_adc_new xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.soc_adc_new -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log soc_adc_new_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./soc_adc_new.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: soc_adc_new.sh [-help]\n\
Usage: soc_adc_new.sh [-step]\n\
Usage: soc_adc_new.sh [-lib_map_path]\n\
Usage: soc_adc_new.sh [-reset_run]\n\
Usage: soc_adc_new.sh [-reset_log]\n\
Usage: soc_adc_new.sh [-keep_index]\n\
Usage: soc_adc_new.sh [-noclean_files]\n\n\
