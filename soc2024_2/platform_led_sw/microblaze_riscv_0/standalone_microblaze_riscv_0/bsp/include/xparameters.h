...
/* Definitions for peripheral AXI_GPIO_LED_SW */
#define XPAR_AXI_GPIO_LED_SW_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_AXI_GPIO_LED_SW_BASEADDR 0x40000000
#define XPAR_AXI_GPIO_LED_SW_HIGHADDR 0x4000ffff
#define XPAR_AXI_GPIO_LED_SW_INTERRUPT_PRESENT 0x0
#define XPAR_AXI_GPIO_LED_SW_IS_DUAL 0x1
#define XPAR_AXI_GPIO_LED_SW_GPIO_WIDTH 0x10

/* Canonical definitions for peripheral AXI_GPIO_LED_SW */
